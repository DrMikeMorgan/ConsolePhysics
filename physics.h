...
public:
	Particle():pos(),vel(),acc(0,15.0),forceAccum(),damping(0.98){}
	Particle(const float& x, const float& y, const float& mass):pos(x,y),vel(),acc(0,15.0),forceAccum(),damping(0.98){setMass(mass);}
